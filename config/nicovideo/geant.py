...
trace_folder = "/home/federerjiang/workplace/icarus_jiang/trace/nicovideo/"
trace_file = trace_folder + "nico_20160108_to_20160121_14_days-feeder.txt.out.dat"
contents = trace_folder + "contents.txt"
N_CONTENTS = 292248
N_WARMUP_REQUESTS =  400000
N_MEASURED_REQUESTS = 570000
        ...
        for strategy in STRATEGIES:
            for network_cache in NETWORK_CACHE:
                ...
                experiment['desc'] = "Alpha: %s, branching factor: %s, strategy: %s, topology: %s, network cache: %s" \
                                     % (str(alpha), str(degree), strategy, 'GEANT', str(network_cache))
