...
python printresults.py results-standard.pickle > results/results-telstra-irm.txt
...
echo "Simulation is finished"
echo "Get Results: Latency and Hit Ratios"
python printresults.py results-edge.pickle >> results/results-telstra-irm.txt
echo "Results are saved to file results.txt"
...
echo "Simulation is finished"
echo "Get Results: Latency and Hit Ratios"
python printresults.py results-coor-edge.pickle >> results/results-telstra-irm.txt
echo "Results are saved to file results.txt"
