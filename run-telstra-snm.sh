...
python printresults.py results-standard.pickle > results/telstra-snm.txt
...
echo "Simulation is finished"
echo "Get Results: Latency and Hit Ratios"
python printresults.py results-edge.pickle >> results/telstra-snm.txt
echo "Results are saved to file results.txt"

echo "Run telstra coordinated edge experiments"
python icarus.py --results results-coor-edge.pickle config/snm/telstra-coor.py
echo "Simulation is finished"
echo "Get Results: Latency and Hit Ratios"
python printresults.py results-coor-edge.pickle >> results/telstra-snm.txt
echo "Results are saved to file results.txt"
